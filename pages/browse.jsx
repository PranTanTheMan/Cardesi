    ...
    <>
      ...
      <Wrap className="cars-container" spacing="40px" placeContent={"center"}>
        ...
        <CarCard
          make="Jeep"
          name="Jeep Wrangler"
          smallDescription="SUV with a spacious interior, and excellent off-road capability. It has a 25MPG city and 32MPG highway."
          bigDescription="The Jeep Wrangler is a rugged SUV with a spacious interior, advanced technology features, and excellent off-road capability. It offers a range of engine options, including gasoline and diesel, and comes with a spacious trunk for storage."
          condition="Good"
          year="2012"
        ...
        <CarCard
          ...
          bigDescription="The Ford F-150 is a versatile pickup truck with a spacious interior, advanced technology features, and powerful performance. It offers a range of engine options, including gasoline and diesel, and comes with a spacious trunk for storage."
          condition="Fair"
          year="2020"
          image="/FordF.jpeg"
          price="30,000"
        ...
        <CarCard
          ...
          smallDescription="The Chevrolet Silverado is a versatile pickup truck , and off-road capability. It has a 25MPG city and 32MPG highway."
          bigDescription="The Chevrolet Silverado is a versatile pickup truck with a spacious interior, advanced technology features, and powerful performance. It offers a range of engine options, including gasoline and diesel, and comes with a spacious trunk for storage."
          condition="Good"
          year="2019"
          image="/Silverado.jpg"
          price="25,000"
        ...
        <CarCard
          make={"Subaru"}
          name={"Subaru Outback"}
          smallDescription=" A versatile SUV with a spacious interior, and off-road capability. It has a 25MPG city and 32MPG highway."
          bigDescription="The Subaru Outback is a versatile SUV with a spacious interior, advanced technology features, and powerful performance. It offers a range of engine options, including gasoline and diesel, and comes with a spacious trunk for storage."
          condition="Fair"
          year="2019"
          image="/Outback.jpg"
          price="22,000"
        ...
        <CarCard
          ...
          bigDescription="The Dodge Challenger is a powerful sports car with a spacious interior, advanced technology features, and bold styling. It offers a range of engine options, including gasoline and high-performance options, and comes with a spacious trunk for storage."
          condition="Mint"
          year="2018"
        ...
        <CarCard
          ...
          bigDescription="The Kia Optima is a stylish mid-size car with a spacious interior, advanced technology features, and efficient performance. It offers a range of engine options, including gasoline and hybrid, and comes with a spacious trunk for storage."
          condition="Excellent"
          year="2017"
          image="/KiaOptima.jpg"
          price="17,000"
        ...
        <CarCard
          ...
          bigDescription="The Hyundai Sonata is a comfortable mid-size car with a spacious interior, advanced technology features, and refined handling. It offers a range of engine options, including gasoline and hybrid, and comes with a spacious trunk for storage."
          condition="Good"
          year="2018"
