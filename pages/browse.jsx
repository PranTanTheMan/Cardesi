...
export default function Browse() {
  return (
    <>
      ...
      <Flex px="2rem" direction={"column"} marginTop={"20px"}>
      ...
      <Wrap className="cars-container" spacing="40px" placeContent={"center"}>
        ...
        bigDescription={"The hybrid powertrain has become a more significant part of the Accord lineup for this new generation as it's standard on all but the two least-expensive trims. Those two, the LX and EX, are powered by the familiar 192-hp, 1.5-liter turbocharged four-cylinder gas engine carried over from the outgoing model—and they come exclusively with a continuously variable automatic transmission (CVT). "}
       />
